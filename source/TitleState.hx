...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			switch (curBeat)
			{
				case 1:  createCoolText(['Psych Engine by'], 45);
				case 3:  addMoreText('Shadow Mario', 45); addMoreText('RiverOaken', 45);
				case 4:  deleteCoolText();
				case 5:  createCoolText(['This is a mod to'], -60);
				case 7:  addMoreText('This game right below lol', -60); logoSpr.visible = true;
				case 8:  deleteCoolText(); logoSpr.visible = false;
